...
require 'json'
  def call_java_check
    output = `java -cp "/Users/manny/Documents/Work/ruby/CodeRoomDev/app/controllers/build/classes" java_parser.CheckAnnotation`
    text_file = File.new('/Users/manny/Documents/Work/ruby/CodeRoomDev/app/controllers/json_file.txt', "r").read
